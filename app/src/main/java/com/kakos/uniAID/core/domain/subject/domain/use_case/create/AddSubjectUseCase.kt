package com.kakos.uniAID.core.domain.subject.domain.use_case.create
 ...
 *
 * Encapsulates the logic for creating new subjects, handling validation
...
class AddSubjectUseCase(
    ...
    private val tag = "AddSubjectUseCase"
    ...
    suspend operator fun invoke(subject: Subject): Long {
        ...
        Log.e(tag, "Subject added: $subject")
