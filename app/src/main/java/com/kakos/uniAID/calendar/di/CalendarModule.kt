...
/**
 * Dagger Hilt module for providing calendar dependencies.
 *
 * Installed in SingletonComponent, provides EventUseCases and related dependencies.
 *
 * Responsibilities:
 * - Provides instances of calendar-related use cases
 * - Ensures singleton instances where needed
 * - Injects EventRepository into components
 */
@Module
